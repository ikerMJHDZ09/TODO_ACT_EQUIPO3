...
class RegisterUserUseCaseTest {
    ...
    @Test
    void debe_crear_usuario_en_firebase_y_guardar_en_repositorio() throws FirebaseAuthException {
    ...
    @Test
    void debe_propagar_excepciones_de_firebase() throws FirebaseAuthException {
        RegisterUserDto dto = new RegisterUserDto();
